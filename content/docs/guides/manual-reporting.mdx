...
Any game on your instance except Counter-Strike 2 is reported manually. A fresh install comes with nineteen of them, added as [game packs](/modules):

Rocket League, Valorant, League of Legends, Dota 2, Deadlock, Overwatch 2, Rainbow Six Siege, Battlefield 6, Call of Duty, Team Fortress 2, Trackmania, chess, Minecraft, EA Sports FC, Super Smash Bros. Ultimate, Street Fighter 6, Tekken 8, osu! and Age of Empires II.

Add more from **Modules** → **Browse**, or remove the ones you never run. See [Add a game](/modules#add-a-game).
