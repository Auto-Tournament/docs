...
- Update Auto Tournament CS2 (formerly MatchZy Enhanced) on your servers too, so all servers run the same version. See [Update the CS2 plugin](/cs2/plugin/install#update), or run `sudo csm update-plugins` with CS2 Server Manager.
