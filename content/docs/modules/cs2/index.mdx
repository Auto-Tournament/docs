...
| [Auto Tournament CS2](/cs2/plugin) | On each CS2 server | Yes |
| [CS2 Server Manager](/cs2/server-manager) | On the Linux machine with the CS2 servers | No, but recommended |

The CS2 plugin is made for Auto Tournament. It adds more events, a match report, simulation mode and a retry queue for events. See [Auto Tournament CS2](/cs2/plugin) for what it is based on.
