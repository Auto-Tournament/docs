...
- Metamod:Source. Use `2.0.0.1411` for now, see the note on [MatchZy Enhanced](/modules/cs2/matchzy-enhanced#1-install-metamodsource-and-counterstrikesharp).
- CounterStrikeSharp.
- MatchZy Enhanced, the same version on all servers.
- An RCON password.
