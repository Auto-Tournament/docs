...
- [MatchZy Enhanced](/modules/cs2/matchzy-enhanced), a plugin on each CS2 server. It is required.
- [CS2 Server Manager](/modules/cs2/server-manager), a tool that installs and runs CS2 servers. It is optional, but it is the easiest way to get servers.
