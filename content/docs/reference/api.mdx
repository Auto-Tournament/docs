...
The repository has a working Discord bot that you can copy: [examples/discord-bot](https://github.com/Auto-Tournament/auto-tournament/tree/main/examples/discord-bot).
