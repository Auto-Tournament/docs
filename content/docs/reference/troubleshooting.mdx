...
### Server can't reach Auto Tournament (webhook), or no events
...
3. Check that Auto Tournament CS2 is loaded: run `css_plugins list` in the server console. The plugin shows up as Auto Tournament CS2.
...
- With CS2 Server Manager and its MySQL container: run `sudo csm`, open **Tools** and choose **Auto Tournament CS2 DB: verify/repair**.
- With your own MySQL: check `game/csgo/cfg/AutoTournamentCS2/database.json` (with CS2 Server Manager: `/home/cs2servermanager/overrides/game/csgo/cfg/AutoTournamentCS2/database.json`), that the database host is reachable, and the user and password.
